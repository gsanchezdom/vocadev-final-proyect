...
juego_pong_facil = os.path.abspath("pong_facil.py")
juego_pong_medio = os.path.abspath("pong_medio.py")
juego_pong_dificil = os.path.abspath("pong_dificil.py")
...
AZUL = (0, 0, 255)
NARANJA = (255, 128, 0)
COLOR_TEXTO = (250, 133, 133)

screen = 1280, 720
screen = pygame.display.set_mode((screen))
pygame.display.set_caption("Menú Pong")
...
text = font.render("Pong!", True, (235, 90, 60))
        ...
        if event.type == pygame.QUIT:
            ...
            if event.button == 1:
                if inside_button_easy(mouse_pos):
                    os.system(juego_pong_facil)
                if inside_button_medium(mouse_pos):
                    os.system(juego_pong_medio)
                if inside_button_hard(mouse_pos):
                    os.system(juego_pong_dificil)
                else:
                    pass
